import os
# pages.py  -  __PANEL_NAME__ v9.8
# شامل: LOGIN_HTML, DASHBOARD_HTML, get_public_page_html()

# لوگوی __PANEL_NAME__ (به‌صورت base64 داخلی، بدون نیاز به هاست خارجی)
...
<title>ورود · __PANEL_NAME__</title>
...
<div class="wrap">
  <div class="card">
    <div class="brand">
      <div class="brand-img"><img src="data:image/png;base64,__LOGO_B64__" alt="__PANEL_NAME__"></div>
      <div><div class="brand-name">__PANEL_NAME__</div><div class="brand-sub">v9.8</div></div>
    </div>
    <h1>ورود به پنل</h1>
...
.pc-trojan{background:var(--green-bg);color:var(--green-t)}
.pc-vmess{background:var(--amber-bg);color:var(--amber-t)}
...
<div class="modal-bg" id="modal-edit-link">
  <div class="modal">
    ...
    <div class="fg" style="margin-bottom:13px"><label>پروتکل</label><select class="fs" id="el-proto" style="width:100%"><option value="vless-ws">VLESS / WS</option><option value="xhttp">XHTTP · auto</option><option value="trojan-ws">Trojan / WS</option><option value="vmess-ws">VMess / WS</option></select></div>
...
<div class="mob-top">
  <div class="ml">
    <div class="mob-logo"><img src="data:image/png;base64,__LOGO_B64__" alt="__PANEL_NAME__"></div>
    <span class="mob-title">__PANEL_NAME__</span>
  </div>
  <div class="mob-right">
...
<aside class="sidebar" id="sb">
  ...
  <div class="logo">
    <div class="logo-img"><img src="data:image/png;base64,__LOGO_B64__" alt="__PANEL_NAME__"></div>
    <div><div class="logo-name">__PANEL_NAME__</div><div class="logo-sub">v9.8</div></div>
  </div>
  <div class="nav-wrap">
...
<section class="pg on" id="pg-overview">
  ...
  <div class="dash-footer">
    <span class="df-text">__PANEL_NAME__ v9.8 · Railway</span>
  ...
  <div class="create-panel">
    ...
    <div class="cp-body">
      ...
      <div class="cp-block mb16">
        ...
        <div class="proto-cards" style="grid-template-columns:repeat(4,1fr)">
          ...
          <div class="proto-card" data-val="xhttp" onclick="selectProto('xhttp',this)">
            ...
            <div class="proto-card-desc">packet-up / stream-up</div>
          </div>
          <div class="proto-card" data-val="trojan-ws" onclick="selectProto('trojan-ws',this)">
            <div class="proto-card-check"><i class="ti ti-check"></i></div>
            <div class="proto-card-icon"><i class="ti ti-brand-tor"></i></div>
            <div class="proto-card-title">Trojan / WS</div>
            <div class="proto-card-desc">TLS + WebSocket</div>
          </div>
          <div class="proto-card" data-val="vmess-ws" onclick="selectProto('vmess-ws',this)">
            <div class="proto-card-check"><i class="ti ti-check"></i></div>
            <div class="proto-card-icon"><i class="ti ti-brand-vimeo"></i></div>
            <div class="proto-card-title">VMess / WS</div>
            <div class="proto-card-desc">VMess + WebSocket</div>
          </div>
        </div>
      </div>
      <div class="cp-row">
...
<section class="pg" id="pg-support">
  ...
  <div class="srv-panel">
    <div class="srv-hero">
      ...
      <div class="srv-hero-text">
        <div class="srv-hero-domain">پشتیبانی __PANEL_NAME__</div>
        <div class="srv-hero-sub"><span class="dot dg pulse"></span> راه‌های ارتباطی با تیم __PANEL_NAME__</div>
      </div>
    </div>
    <div class="srv-tiles">
...
function protoBadge(p){
  const m={'vless-ws':['VLESS · WS','pc-ws'],'xhttp':['XHTTP · auto','pc-xhttp'],'trojan-ws':['Trojan · WS','pc-trojan'],'vmess-ws':['VMess · WS','pc-vmess']};
...
async function saveEditLink(){
  ...
  const body={label,protocol,note,limit_value:val||0,limit_unit:unit,fingerprint,alpn,port,ip_limit,speed_limit_value,speed_limit_unit};
...
PANEL_NAME = os.environ.get("PANEL_NAME", "X4G")
LOGIN_HTML = LOGIN_HTML.replace("__PANEL_NAME__", PANEL_NAME)
DASHBOARD_HTML = DASHBOARD_HTML.replace("__PANEL_NAME__", PANEL_NAME)
...
<title>__PANEL_NAME__ Sub</title>
<link rel="preconnect" href="https://fonts.googleapis.com">
...
<div class="wrap">
  <div class="top">
    <div class="brand">
      <div class="brand-img"><img src="data:image/png;base64,{LOGO_B64}" alt="__PANEL_NAME__"></div>
      <div><div class="brand-name">__PANEL_NAME__</div><div class="brand-sub">v9.8</div></div>
    </div>
  ...
  <div class="footer">پشتیبانی: <a href="https://t.me/X4GHUB" target="_blank">@X4GHUB</a> · __PANEL_NAME__ v9.8</div>
</div>
<script>
...
function protoChip(p){{
  if(p==='xhttp')return '<span class="proto-chip pc-xhttp"><i class="ti ti-bolt"></i> XHTTP · auto</span>';
  if(p==='trojan-ws')return '<span class="proto-chip pc-trojan"><i class="ti ti-shield-lock"></i> Trojan · WS</span>';
  if(p==='vmess-ws')return '<span class="proto-chip pc-vmess"><i class="ti ti-brand-vimeo"></i> VMess · WS</span>';
  return '<span class="proto-chip pc-ws"><i class="ti ti-link"></i> VLESS · WS</span>';
}}
...
init();
    ...
    return html.replace("__PANEL_NAME__", PANEL_NAME)
